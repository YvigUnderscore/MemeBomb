...
function updateTray() {
  ...
  const menu = Menu.buildFromTemplate([
    ...
    { type: 'separator' },
    ...updateItem,
    { label: 'Replay last meme', accelerator: cfg.shortcuts.replayLast || undefined, enabled: !!lastIncoming, click: () => replayLast() },
    { label: 'React to last meme', submenu: emojis.map((e, i) => ({ label: e, accelerator: cfg.shortcuts[`react${i + 1}`] || undefined, click: () => reactToLast(e) })) },
    { type: 'separator' },
    { label: 'Meme editor (web)…', accelerator: cfg.shortcuts.openEditor || undefined, click: openWebEditor },
